...
const Homepage = () => {
    ...
    const FeatureCard = ({ icon, title, description, isActive, index }) => (
        <div
            className={`relative p-8 rounded-2xl transition-all duration-500 transform ${isActive
        ...
        >
            <div className={`flex items-center justify-center h-16 w-16 rounded-full mx-auto mb-6 transition-all duration-300 ${isActive ? 'bg-gradient-to-br from-primary to-primary-dark shadow-lg' : 'bg-primary/10'
                }`}>
                <div className={isActive ? 'text-white' : 'text-primary'}>
                    {icon}
                </div>
            </div>
            <h3 className={`text-xl font-bold text-center mb-4 transition-colors duration-300 ${isActive ? 'text-primary' : 'text-neutral-darkest'
                }`}>
                {title}
            </h3>
            <p className={`text-center transition-colors duration-300 ${isActive ? 'text-primary-dark' : 'text-neutral-dark'
                }`}>
                {description}
            </p>
            {isActive && (
                ...
                <div className="container mx-auto px-4">
                    <div className="grid grid-cols-1 md:grid-cols-4 gap-8">
                        ...
                        <div className="col-span-1 md:col-span-2">
                            <h3 className="text-2xl font-bold text-primary mb-4">AuctionGhar</h3>
                    ...
                    <div className="border-t border-neutral-dark mt-8 pt-8 text-center">
                        <p className="text-neutral-light">
                            © {new Date().getFullYear()} AuctionGhar. All rights reserved to{' '}
